...
;(function($) {
    ...
    function init(options) {
        return this.each(function() {
            ...
            var initial = {
                ...
                count: count,
                upvoted: $(this).find(dot_upvote_css).size(),
                downvoted: $(this).find(dot_downvote_css).size(),
    ...
    function render(that) {
        ...
        if (data.upvoted) {
            ...
            //that.find(dot_downvote_css).removeClass(enabled_css);
        }
        /*
        else if (data.downvoted) {
            that.find(dot_upvote_css).addClass(upvoted_css);
            //that.find(dot_downvote_css).removeClass(downvoted_css);
            //that.find(dot_upvote_css).removeClass(enabled_css);
        }
        */
        else {
